...
/**
 * Технический символ в начале комментария = запись отменена.
 * Сами комментарии остаются append-only: смотрим только на последний.
 * Символ выбран так, чтобы его не набрали случайно с клавиатуры.
 */
export const CANCEL_MARK = '∅';
